...
#define PRODUCT_NAME           "slint-template" // 产品名称
...
#define INTERNAL_NAME          "slint-template.exe"
#define FILE_DESCRIPTION       ""  // 文件说明
#define LEGAL_COPYRIGHT        "Copyright 2023-2033 The Heng30 Company Ltd. All rights reserved." // 版权
#define ORIGINAL_FILE_NAME     "slint-template.exe"    // 原始文件名
